...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "BlogSphere AI" },
      { property: "og:title", content: "BlogSphere AI" },
      { property: "og:description", content: "Where ideas get edited." },
      ...
      <AuthProvider>
        <div className="min-h-screen flex flex-col bg-background text-foreground grain">
          ...
          <footer className="border-t border-border py-10 text-center text-xs uppercase tracking-[0.25em] text-muted-foreground">
            BlogSphere AI · Crafted with care
          </footer>
        </div>
        <Toaster />
      </AuthProvider>
